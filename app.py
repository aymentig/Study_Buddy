...
def call_openai_for_study_pack(text: str, n_questions: int = 5):
    ...
    n = max(1, min(int(n_questions or 5), 20))  # 1..20

    system = (
        "You are StudyBuddy, a concise, friendly study assistant that can break down complex topics. Given course material, "
        f"produce: (1) a tight summary (120-280 words), (2) 5-20 bullet key points, "
